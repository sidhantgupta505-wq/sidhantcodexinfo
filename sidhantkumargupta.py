...
"""
============================================
SIDHANT CODEX - NUMBER INFORMATION
...
<div class="disclaimer-overlay" id="disclaimerOverlay">
    <div class="disclaimer-box">
        ...
        <div class="brand-name">SIDHANT CODEX</div>
        <h2>DISCLAIMER</h2>
...
<div class="main-header">
    <div class="container">
        <div class="logo-section">
            <img src="https://i.postimg.cc/8JcY2xCL/image.png" alt="Sidhant Codex Logo" class="logo-img" draggable="false">
            <div class="title-section">
                <h1>
                    <span class="brand">SIDHANT</span> CODEX
                </h1>
                <div class="sub-title">🔴  WEB DEVELOPER · SECURITY RESEARCH · INTELLIGENCE</div>
            </div>
        </div>
...
<div class="main-container">
    ...
    <div class="card">
        ...
        <div class="card-header"> 
            ...
            <img src="https://i.postimg.cc/8JcY2xCL/image.png" alt="Sidhant Codex Logo" class="logo-icon" draggable="false">
        ...
        <div class="card-body">
            ...
            <div class="security-badge">
                ...
                <div class="badge-item"><i class="fas fa-shield-halved"></i> SIDHANT GUPTA</div>
                <div class="badge-item"><i class="fas fa-check-circle"></i> Verified</div>
                <div class="badge-item"><i class="fas fa-clock"></i> 24x7 Support</div>
            </div>
            ...
            <div class="social-section">
                <div class="social-title"><i class="fas fa-share-alt"></i> Connect With Sidhant Codex</div>
                <div class="social-buttons">
                    
                    <a href="https://linkedin.com/in/sidhant-gupta-6ba2b3375" target="_blank" class="social-btn linkedin"><i class="fab fa-linkedin"></i> linkedin</a>
                    <a href="https://instagram.com/m.r_sidhant_2x12" target="_blank" class="social-btn instagram"><i class="fab fa-instagram"></i> Instagram</a>
                    <a href="https://t.me/mr_sidhant_2x12" target="_blank" class="social-btn telegram"><i class="fab fa-telegram-plane"></i> Telegram</a>
                </div>
            </div>
...
<div class="footer-section">
    <div class="container">
        <div class="footer-links">
            <a href="#"><i class="fas fa-info-circle"></i> About Sidhant Codex</a>
        ...
        <div style="max-width: 600px; margin: 20px auto; font-family: Arial, sans-serif;">
            ...
            <table border='1' style="width: 100%; border-collapse: collapse; text-align: center;">
                <tr style="background-color: #f2f2f2;">
                    <th style="width: 15%; padding: 8px;">S.No</th>
                    <th style="width: 35%; padding: 8px;">Number</th>
                    <th style="width: 50%; padding: 8px;">Time</th>
                </tr>
        """
...
if __name__ == '__main__':
    ...
    print("\n" + "="*50)
    print("🛡️  SIDHANT CODEX - NUMBER INFORMATION")
    print("="*50)
